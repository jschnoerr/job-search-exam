...
function createResponse(request, body) {
  const responseBodyOrNull = _chunkOJ2CN4LSjs.isResponseWithoutBody.call(void 0, request.status) ? null : body;
...
var XMLHttpRequestController = class {
  constructor(initialRequest, logger) {
    ...
    this.requestId = _chunkQMV2V6GVjs.uuidv4.call(void 0, );
      ...
      methodCall: ([methodName, args], invoke) => {
        ...
        switch (methodName) {
          ...
          case "send": {
            const [body] = args;
            if (body != null) {
              this.requestBody = typeof body === "string" ? _chunkOJ2CN4LSjs.encodeBuffer.call(void 0, body) : body;
            }
  ...
  responseBufferToText() {
    return _chunkOJ2CN4LSjs.decodeBuffer.call(void 0, this.responseBuffer);
  }
  get response() {
    this.logger.info(
    ...
    switch (this.request.responseType) {
      ...
      case "arraybuffer": {
        const arrayBuffer = _chunkOJ2CN4LSjs.toArrayBuffer.call(void 0, this.responseBuffer);
    ...
    construct(target, args, newTarget) {
      ...
      xhrRequestController.onRequest = async function({ request, requestId }) {
        ...
        const resolverResult = await _until.until.call(void 0, async () => {
          ...
          await _chunkQMV2V6GVjs.emitAsync.call(void 0, emitter, "request", {
...
// src/interceptors/XMLHttpRequest/index.ts
var _XMLHttpRequestInterceptor = class extends _chunk3O7223NMjs.Interceptor {
  constructor() {
  ...
  setup() {
    ...
    _outvariant.invariant.call(void 0, 
      !PureXMLHttpRequest[_chunk3O7223NMjs.IS_PATCHED_MODULE],
    ...
    Object.defineProperty(globalThis.XMLHttpRequest, _chunk3O7223NMjs.IS_PATCHED_MODULE, {
      enumerable: true,
      configurable: true,
      value: true
    });
...
//# sourceMappingURL=chunk-EILJI62P.js.map