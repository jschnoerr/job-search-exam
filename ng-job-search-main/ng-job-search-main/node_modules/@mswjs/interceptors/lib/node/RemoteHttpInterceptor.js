...
var _chunkZW4SKXEPjs = require('./chunk-ZW4SKXEP.js');


var _chunkUJRRZPRVjs = require('./chunk-UJRRZPRV.js');


var _chunkGHU3MN2Ojs = require('./chunk-GHU3MN2O.js');
...
var RemoteHttpInterceptor = class extends _chunkZW4SKXEPjs.BatchInterceptor {
  constructor() {
    super({
      name: "remote-interceptor",
      interceptors: [
        new (0, _chunkUJRRZPRVjs.ClientRequestInterceptor)(),
        new (0, _chunkGHU3MN2Ojs.XMLHttpRequestInterceptor)()
      ]
    });
  }
  setup() {
...
var _RemoteHttpResolver = class extends _chunkEM6NYHQVjs.Interceptor {
  constructor(options) {
  ...
  setup() {
    ...
    const handleChildMessage = async (message) => {
      ...
      const { interactiveRequest, requestController } = _chunk4NTPASNTjs.toInteractiveRequest.call(void 0, capturedRequest);
      this.emitter.once("request", () => {
        if (requestController.responsePromise.state === "pending") {
          requestController.respondWith(void 0);
        }
      });
      await _chunk4NTPASNTjs.emitAsync.call(void 0, this.emitter, "request", {
