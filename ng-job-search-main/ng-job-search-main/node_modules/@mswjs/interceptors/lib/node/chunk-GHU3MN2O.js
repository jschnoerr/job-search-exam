...
function createResponse(request, body) {
  const responseBodyOrNull = _chunkJSSEHRRBjs.isResponseWithoutBody.call(void 0, request.status) ? null : body;
...
var XMLHttpRequestController = class {
  constructor(initialRequest, logger) {
    ...
    this.requestId = _chunk4NTPASNTjs.uuidv4.call(void 0, );
    ...
    construct(target, args, newTarget) {
      ...
      xhrRequestController.onRequest = async function({ request, requestId }) {
        ...
        const resolverResult = await _until.until.call(void 0, async () => {
          ...
          await _chunk4NTPASNTjs.emitAsync.call(void 0, emitter, "request", {
...
//# sourceMappingURL=chunk-GHU3MN2O.js.map